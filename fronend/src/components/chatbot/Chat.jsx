...
import { sendChatMessage, api } from "../../api";
  ...
  return (
    <>
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed bottom-5 right-5 w-96 h-[500px] bg-gray-100 shadow-xl rounded-xl flex flex-col overflow-hidden font-sans z-50"
                    ...
                    >
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                          message.type === "bot" ? "bg-blue-500 text-white" : "bg-gray-600 text-white"
                        }`}
                      >
