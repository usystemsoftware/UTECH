...
export default function Kiosks() {
    return (
        <>
            ...
            <PageLayout className="text-center py-12 space-y-10">
                <Headline
                    title="Kiosk Hardware and System Integration"
                />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
                    ...
                    <FadeInWhenVisible>
                        <img
                            ...
                            alt="Migration Planning Dashboard"
                            className="mx-auto w-82 md:w-110"
                        />
                    </FadeInWhenVisible>
                </div>
            </PageLayout>
            ...
            <section className="py-12 bg-secondary">
                <PageLayout className="space-y-10 text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 items-center">
                        <FeaturesList
                            features={customKioskServices.slice(0, 2)}
                            center
                        />
                        ...
                        <FeaturesList
                            features={customKioskServices.slice(2, 4)}
                            center
                        />
                    </div>
                </PageLayout>
            ...
            {/* === FAQ SECTION === */}
            <div className="py-16">
                <FaqSection faqs={kioskFaq} title="FAQ's About Kiosk Software Solutions" />
            </div>
