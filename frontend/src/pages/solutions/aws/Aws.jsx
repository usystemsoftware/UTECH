                    ...
                    <div className="grid grid-cols-1 items-center gap-6 sm:grid-cols-2 ">
                        ...
                        <FadeInWhenVisible delay={0.5}>
                            <img
                                ...
                                alt="Portfolio"
                                className="w-96 sm:w-145 mx-auto"
                            />
                        </FadeInWhenVisible>
                    </div>
                ...
                <div className="grid grid-cols-1 items-center gap-y-7 md:grid-cols-2">
                    ...
                    <FadeInWhenVisible delay={0.5}>
                        <img
                            ...
                            alt="Portfolio"
                            className="w-82 sm:w-96 mx-auto"
                        />
                    </FadeInWhenVisible>
                </div>
                ...
                <PageLayout className="space-y-10 text-center">
                    ...
                    <div className="grid grid-cols-1 gap-6 items-center sm:grid-cols-2">
                        ...
                        <div className="grid justify-center">
                            <TypographyList2 className="text-slate-800 text-left px-4 sm:px-0 [&>li]:mt-3" items={supportServices} />
                        </div>
                    </div>
                    <Button variant="hover">CUSTOMIZE YOUR AWS APPLICATION</Button>
                </PageLayout>
