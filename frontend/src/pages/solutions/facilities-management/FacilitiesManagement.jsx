    ...
    <>
      ...
      <section className="bg-secondary py-16">
        <PageLayout className="space-y-10">
          <Headline title="Artificial Intelligence Integrated into Facility Maintenance" />

          <FeaturesList features={facilityAISolutions} center grid3 />
        </PageLayout>
      </section>
      ...
      <PageLayout className="space-y-10 py-16 text-center">
        ...
        <FeaturesList features={facilityManagementSolutions2} center grid3 />
        <ContactUsButton variant="hover">
      ...
      <section className="bg-primary py-8 text-center">
        <PageLayout className="space-y-4 text-white">
          ...
          <TypographyMuted>
            U Tech’s custom CAFM, CMMS, and IWMS systems are designed to ensure
            compliance with facility management standards, including ISO 41001,
            OSHA regulations, and LEED recommendations. Our solutions align with
            industry best practices to keep your operations efficient and
            compliant
          </TypographyMuted>
        </PageLayout>
      </section>
      ...
      <PageLayout className="py-12 text-center space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          <img
            ...
            className="mx-auto w-96 sm:w-115 md:w-145"
          />
          <FeaturesList2 features={facilityManagementMobileApps} />
        </div>
      </PageLayout>
        ...
        <PageLayout className="space-y-10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            <img
              ...
              alt="Migration Planning Dashboard"
              className="mx-auto w-82 sm:w-98 md:w-145"
            />
            <FeaturesList
      ...
      <PageLayout className="py-12 text-center space-y-10">
        ...
        <FeaturesListOpposite features={facilityManagementSupport} />
      </PageLayout>
