    ...
    <>
      ...
      <PageLayout className="text-center py-12 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          ...
          />
          <FeaturesList features={googleCloudServices} iconAlign="horizontal" />
        </div>
        ...
        <PageLayout className="space-y-10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            ...
            <img
              ...
              alt="Migration Planning Dashboard"
              className="mx-auto w-86 sm:w-135 xl:w-145 2xl:w-155"
            />
          </div>
      ...
      <PageLayout className="py-12 space-y-10">
        ...
        />
        <FeaturesListOpposite features={googleCloudAiServices} />
      </PageLayout>
        ...
        <PageLayout className="space-y-10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
            ...
            <img
              ...
              className="mx-auto w-46 sm:w-54 xl:w-58 2xl:w-68"
            />
            <FeaturesList
          ...
          <ContactUsButton variant="hover">HIRE GCP DEVELOPERS</ContactUsButton>
        </PageLayout>
      </section>
      ...
      <div className="py-16">
        <FaqSection
          faqs={googleCloudFAQ}
          title="Google Cloud Development Services FAQ's"
        />
      </div>
