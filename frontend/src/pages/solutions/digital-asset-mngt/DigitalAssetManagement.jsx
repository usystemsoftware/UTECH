  ...
  return (
    <>
      ...
      <PageLayout className="space-y-10 text-center pt-16">
        ...
        <FeaturesListOpposite features={digitalAssetManagementSolutions} />
      ...
      <PageLayout className="space-y-10 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          ...
          <div className="space-y-3">
            ...
            <TypographyMuted>
              We integrate GDPR-compliant digital rights management (DRM)
              solutions for tracking the release and possession of rich media
      ...
      <PageLayout className="py-16 space-y-10 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          ...
          <img
            ...
            alt="Migration Planning Dashboard"
            className="w-145 xl:w-165 2xl:w-185 mx-auto"
          />
        </div>
      ...
      <section className="bg-secondary py-12">
        <PageLayout className="space-y-10">
          <TypographyH3 className="text-center">FEATURED CONTENT</TypographyH3>
