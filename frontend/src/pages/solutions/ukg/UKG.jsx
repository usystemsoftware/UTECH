...
import { Headline, TypographyH3, TypographySmall } from "@/custom/Typography";
import {
  categories,
  modules,
  portfolioItems,
  ...
  return (
    <>
      ...
      <PageLayout className="py-16 space-y-10 text-center">
        ...
        <FeaturesList features={ukgServices} grid center />

        <ContactUsButton variant="hover">REQUEST A QUOTE NOW</ContactUsButton>
      </PageLayout>
      ...
      <section className="py-16 bg-secondary text-center">
        <PageLayout className="space-y-10">
          ...
          <div className="flex justify-between md:max-w-5xl xl:max-w-6xl gap-4 mx-auto sm:flex-row flex-col">
            <div className="space-y-4 text-start">
              <TypographyH3>UKG Ready Services</TypographyH3>
            ...
            <div className="space-y-4 text-start">
              <TypographyH3>UKG Ready Core Modules</TypographyH3>
            ...
            <div className="space-y-4 text-start">
              <TypographyH3>UKG Ready Other Modules & Add-ons</TypographyH3>
      ...
      <PageLayout className="space-y-10 py-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
          <FeaturesList features={ukgServices2.slice(0, 2)} center />
          <img
            loading="lazy"
            src="/assets//solutions/ukg/custom-ukg-development-services.png"
            alt="Mobile Analytics App"
            className="mx-auto w-110 sm:w-135 md:w-155 xl:w-165"
          />
          <FeaturesList features={ukgServices2.slice(2, 4)} center />
        </div>

        <ContactUsButton variant="hover">GET UKG 24/7 SUPPORTS</ContactUsButton>
      </PageLayout>
