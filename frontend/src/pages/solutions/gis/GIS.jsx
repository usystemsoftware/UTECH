    ...
    <>
      ...
      <PageLayout className="space-y-10 text-center py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
          <FeaturesList features={gisServices.slice(0, 2)} center />
          <img
            loading="lazy"
            src="/assets/solutions/gis/esri-phone-img.png"
            alt="Mobile Analytics App"
            className="mx-auto w-66 sm:w-86 xl:w-92 2xl:w-110"
          />
          <FeaturesList features={gisServices.slice(2, 4)} center />
        </div>
      </PageLayout>
        ...
        <PageLayout className="space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            <img
              ...
              className="w-145 xl:w-155 2xl:w-175 mx-auto"
            />
            <FeaturesList features={gisDataSolutions} iconAlign="horizontal" />
          </div>
        </PageLayout>
      </section>
      ...
      <PageLayout className="py-16 space-y-8">
        ...
        />
        <div className="grid md:grid-cols-2 gap-8 items-center grid-cols-1">
          <img
            loading="lazy"
          ...
          <div>
            <TypographyMuted className="text-center mb-6">
              We have superior application programming expertise in GIS
              programming languages like C++, Visual Basic, Visual C#, Java,
              JSP, ASP, XML, GML, and Cold Fusion. Our GIS Back-end developers
              are proficient in:
            </TypographyMuted>
