  ...
  return (
    <>
      ...
      <PageLayout className="space-y-10 py-16 text-center">
        ...
        <div className="grid grid-cols-1 items-center gap-6 md:grid-cols-2">
          ...
          <img
            ...
            alt="Portfolio"
            className="w-86 sm:w-135 xl:w-155 2xl:w-165 mx-auto order-1 md:order-2"
          />
        </div>
        ...
        <PageLayout className="space-y-10 text-center">
          ...
          <div className="grid grid-cols-1 items-center gap-6 sm:grid-cols-2">
            <img
              ...
              alt="Portfolio"
              className="md:w-54 w-42 xl:w-58 2xl:w-62 mx-auto"
            />
            <FeaturesList
      ...
      <PageLayout className="space-y-16 py-16 text-center">
        <div className="grid grid-cols-1 items-center gap-6 md:grid-cols-2">
          <FeaturesList features={blockchainSolutions} grid center />
          <img
            loading="lazy"
      ...
      <section className="bg-secondary py-16">
        <PageLayout className="space-y-10 text-center">
          ...
          />
          <FeaturesList features={blockchainSolutions2} grid3 center />
          <ContactUsButton variant="hover">
      ...
      <PageLayout className="space-y-10 py-12 text-center">
        <div className="grid grid-cols-1 items-center gap-6 sm:grid-cols-2">
          <FeaturesList features={blockchainServices} iconAlign="horizontal" />
          <img
            loading="lazy"
            src="/assets/solutions/blockchain/10005.png"
            alt="Portfolio"
            className="md:w-54 w-48 xl:w-58 2xl:w-62 mx-auto"
          />
        </div>
        <ContactUsButton variant="hover">
          GET CUSTOM NFT SOFTWARE
        </ContactUsButton>
      </PageLayout>
        ...
        <PageLayout className="space-y-10 text-center">
          ...
          <div className="grid grid-cols-1 items-center gap-6 md:grid-cols-2">
            <img
              ...
              alt="Portfolio"
              className="w-96 sm:w-110 xl:w-120 2xl:w-130 mx-auto"
            />
