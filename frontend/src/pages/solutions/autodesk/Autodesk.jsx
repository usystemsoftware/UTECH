    ...
    return (
        <>
            ...
            <PageLayout className="space-y-10 py-16 text-center">
                ...
                />
                <div className="grid grid-cols-1 gap-y-7 gap-4 items-center sm:grid-cols-2">
                    <FadeInWhenVisible delay={0.5}>
                        <img
                            loading="lazy"
