...
export const uiuxServices = [
    ...
    },
    {
        ...
        description: "We utilize frameworks like Xamarin, DevExpress, Ionic, Apache Cordova, and Appcelerator to deliver highly responsive UI/UX designs that fully leverage touchscreen functionality and provide mobile-first user experiences for progressive web apps..",
    },
    {
        icon: "Smartphone",
    ...
    },
    {
        ...
        description: "We use well-known UI guidelines like Human Interface Guidelines (HIG) and Material Design to develop intuitive solutions with goal-driven, usable designs that influence positive user responses and facilitate simple communication between a user and the interface.",
    },
];
...
export const processSteps = [
    {
        ...
        description: "During the discovery process, we thoroughly research user information, technical restraints, and business goals and requirements through user and stakeholder interviews, content and site audits, task analysis, and ecosystem mapping.",
    },
    {
        icon: "Smartphone",
        title: "In-Depth User Research",
        description: "Our in-depth user research processes provide valuable insights into what features users will be expecting from a product. We create user profiles and user journeys to understand behavioral aspects and improve workflows.",
    },
    {
        icon: "FileText",
        title: "UX Audit Process",
        description: "We use empirical methods to boost conversions and ensure that key user-specific activities such as actions, menu items, and main navigation are easily located and identifiable, making it easy for users to achieve their goals within the site.",
    },
    {
        icon: "FileText",
        title: "Gathering Requirements",
        description: "We perform in-depth research to gain a complete understanding of the project and create a requirements definition document that descriptionribes each project requirement in great detail and assists in keeping the project on track.",
    },
];
