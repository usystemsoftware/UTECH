...
export const frontendTech = [
    {
        name: "JavaScript",
        img: "/assets/solutions/web-development/javascript.png",
        description: "Our software engineers use JavaScript to calculate, manipulate, and validate different data to create dynamic and interactive user experiences.",
        highlight: "JavaScript",
    },
    {
        name: "HTML",
        img: "/assets/solutions/web-development/html.png",
        description: "Our Software Development Team has many years of collective experience working with HTML programming language for developing best-in-class custom websites and applications.",
        highlight: "HTML",
    },
    {
        name: "JSON",
        img: "/assets/solutions/web-development/json.png",
        description: "We use JSON for transmitting web application data in a much quicker and more efficient fashion to optimize the process of building your web application.",
        highlight: "JSON",
    },
    {
        name: "ELM",
        img: "/assets/solutions/web-development/elm.png",
        description: "Our Software Development Team utilizes ELM’s functionality, user-friendliness, fast compilation, and safe refactoring benefits to build, integrate, and customize your website or application.",
        highlight: "",
    },
    {
        name: "AngularJS",
        img: "/assets/solutions/web-development/angularjs.png",
        description: "We use AngularJS when creating dynamic web applications, appropriating its data binding, and dependency injection to eliminate the need to write an extensive amount of code.",
        highlight: "AngularJS",
    },
    {
        name: "jQuery",
        img: "/assets/solutions/web-development/jquery.png",
        description: "We utilize jQuery to easily navigate a document, create animations, develop AJAX applications, select DOM elements, handle events, and create plug-ins on top of the JavaScript library.",
        highlight: "jQuery",
    },
];

export const backendTechDetails = [
    {
        name: "PHP",
        img: "/assets/solutions/web-development/php.png",
        highlight: "PHP frameworks",
        description: "Our Software Development Team uses PHP frameworks to provide a basic structure for streamlining and speeding up the development process of building personalized web websites and apps.",
    },
    {
        name: "Express.js",
        img: "/assets/solutions/web-development/expressjs.png",
        highlight: "web application development",
        description: "Our experts utilize Express.js to simplify the web application development process, making it easier to write fast, secure, and modular applications.",
    },
    {
        name: "Node.js",
        img: "/assets/solutions/web-development/node-js.png",
        highlight: "Node.js",
        description: "We use Node.js to create traditional websites, back-end API services, and data-intensive real-time applications that run across distributed devices.",
    },
    {
        name: "Java",
        img: "/assets/solutions/web-development/java.png",
        highlight: "Java",
        description: "We use Java as a general-purpose programming language to develop custom mobile and web applications, embedded systems, and big data processing.",
    },
    {
        name: "Python",
        img: "/assets/solutions/web-development/python.png",
        highlight: "Python",
        description: "We use Python as one of our primary programming languages for mobile and custom web development, video games, operating systems, machine learning, AI, and more.",
    },
    {
        name: "MongoDB",
        img: "/assets/solutions/web-development/mongo-db.png",
        highlight: "MongoDB",
        description: "Our Website Developers use MongoDB for optimizing the performance of transactional stores and for high volume data storage purposes.",
    },
];
...
export const webDevelopmentFaqs = [
    ...
    },
    {
        ...
        answer:
            "Progressive web apps (PWA) provides a native app experience from your browser, circumnavigating the need for advanced hardware. PWA Developers make progressive web app solutions wo ddliver perks like offline capabilities, faster load times, push notifications, and of course, better user engagement.",
    },
    {
        question:
    ...
    },
    {
        ...
        answer:
            "U Technology’s engineers are experienced in PWA (Progressive Web Apps), using our web development experience. Our solutions wncldde creating web applications that are responsive, function offline, have push notifications, and background data syncing.",
    },
    {
        question:
