  ...
  return (
    <>
      ...
      <PageLayout className="py-16 space-y-10 text-center">
        ...
        <FeaturesListOpposite features={sapServices} />
      ...
      <section className="py-16 bg-secondary">
        <PageLayout className="space-y-10 text-center">
          ...
          <FeaturesList grid3 center features={sapIndustrySolutions} />

          <ContactUsButton variant="hover">GET SAP SOLUTIONS</ContactUsButton>
        </PageLayout>
      </section>
      ...
      <PageLayout className="text-center py-12 space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
          <FeaturesList features={sapAISolutions} iconAlign="horizontal" />
          <img
            loading="lazy"
            src="/assets//solutions/sap/email-marketing.png"
            alt="Migration Planning Dashboard"
            className="mx-auto w-86 sm:w-96 md:w-110 xl:w-120"
          />
        </div>

        <ContactUsButton variant="hover">INTEGRATE AI IN SAP</ContactUsButton>
      </PageLayout>
        ...
        <PageLayout className="space-y-8">
          ...
          <div className="flex justify-between items-center md:max-w-5xl gap-4 mx-auto sm:flex-row flex-col">
            <div className="space-y-4 text-start">
              <TypographyH3>SAP Modules</TypographyH3>
            ...
            <img
              ...
              className="sm:w-96 w-72 mx-auto"
            />
            <div className="space-y-4 text-start">
              <TypographyH3>SAP Products</TypographyH3>
      ...
      <PageLayout className="text-center py-10 space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
          <img
            ...
            alt="Migration Planning Dashboard"
            className="mx-auto w-86 sm:w-96 md:w-135"
          />
