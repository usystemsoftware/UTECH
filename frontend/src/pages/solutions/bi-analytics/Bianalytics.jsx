    ...
    <>
      ...
      <PageLayout className="space-y-10 py-16 text-center">
        ...
        <div className="grid grid-cols-1 items-center gap-6 md:grid-cols-2">
          <FeaturesList features={biServices} iconAlign="horizontal" />
          <img
            loading="lazy"
      ...
      <PageLayout className="space-y-10 py-12 text-center">
        <FeaturesList features={biNewServices} grid3 center />
        <ContactUsButton variant="hover">
          HIRE BI SOFTWARE DEVELOPERS
        </ContactUsButton>
      </PageLayout>
      ...
      <section className="bg-secondary py-16">
        <PageLayout className="space-y-10 text-center">
          <Headline
            ...
            description="U tech’s engineers create custom business intelligence (BI) cloud app solutions that utilize AI-powered software, IoT technologies, and/or big data storage to optimize core business operations."
          />
          <div className="grid grid-cols-1 items-center gap-6 md:grid-cols-2">
            <img
              loading="lazy"
              ...
              alt="Portfolio"
              className="w-155 sm:w-165 xl:w-175 2xl:w-195 mx-auto"
            />
            <FeaturesList features={cloudSolutions} iconAlign="horizontal" />
          </div>
          <ContactUsButton variant="hover">
      ...
      <PageLayout className="space-y-10 py-16 text-center">
        ...
        <ContactUsButton variant="hover">
          GET AI-ENABLED BI SOLUTIONS
        </ContactUsButton>
      </PageLayout>

      <PageLayout className="space-y-10 py-12 text-center">
        <FeaturesList features={biAnalyticsSolutions} grid3 center />
        <ContactUsButton variant="hover">
      ...
      <PageLayout className="space-y-10 py-5 text-center">
        ...
        <div className="grid grid-cols-1 items-center gap-6 md:grid-cols-2">
          <img
            ...
            className="w-145 xl:w-155 2xl:w-175 mx-auto"
          />
          <FeaturesList features={biExtraSolutions} iconAlign="horizontal" />
        </div>
        <ContactUsButton variant="hover">
          GET AI-ENABLED BI SOLUTIONS
        </ContactUsButton>
      ...
      <PageLayout className="space-y-10 py-12 text-center">
        <FeaturesList features={biAdvancedSolutions} grid3 center />
        <ContactUsButton variant="hover">
          CUSTOMIZE YOUR BI FEAUTURES NOW
        </ContactUsButton>
      </PageLayout>
      ...
      <section className="bg-secondary">
        <PageLayout className="space-y-10 py-12 text-center">
          <Headline
            ...
            description="At U tech, we are dedicated to empowering your business with strategic insights and data-driven decision-making. With our customized business intelligence outsourcing, we commit to delivering comprehensive solutions that propel your organization toward success."
          />
          <FeaturesListOpposite features={biOutsourcingServices} />
          <ContactUsButton variant="hover">
            BI SOFTWARE SUPPORT SERVICES
          </ContactUsButton>
        </PageLayout>
      </section>
      ...
      <PageLayout className="space-y-10 py-12 text-center">
        <Headline
          ...
          description="At U tech, we are dedicated to empowering your business with strategic insights and data-driven decision-making. With our customized business intelligence outsourcing, we commit to delivering comprehensive solutions that propel your organization toward success."
        />
        <FeaturesList features={biPlatformIntegrations} grid3 center />
        <ContactUsButton variant="hover">
          INTEGRATE YOUR BI SOLUTIONS
        </ContactUsButton>
      </PageLayout>
      ...
      <section className="py-10">
        <FaqSection
          faqs={Faqs}
          title="FAQs: Business Intelligence Software Development"
        />
      </section>
