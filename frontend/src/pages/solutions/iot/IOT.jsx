  ...
  return (
    <>
      ...
      <PageLayout className="py-16 space-y-10 text-center">
        ...
        <FeaturesListOpposite features={IoTServices} />

        <ContactUsButton variant="hover">GET IOT DEVELOPERS</ContactUsButton>
      </PageLayout>
      ...
      <section className="bg-secondary py-12">
        <PageLayout className="space-y-10 text-center">
          ...
          <FeaturesListOpposite features={AIoTServices} />
        </PageLayout>
      </section>
        ...
        <PageLayout className="text-center space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            <img
              ...
              alt="Migration Planning Dashboard"
              className="mx-auto w-96 md:w-135 xl:w-145 2xl:w-155 hidden md:block"
            />
            <FeaturesList
