    ...
    <>
      ...
      <PageLayout className="py-12 text-center space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          <img
            ...
            className="mx-auto w-86 sm:w-125 md:w-135 xl:w-145 2xl:w-155"
          />
          <FeaturesList features={fraudSolutions} iconAlign="horizontal" />
        </div>
        ...
        <PageLayout className="text-center space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
            ...
            <img
              ...
              alt="Migration Planning Dashboard"
              className="mx-auto w-42 sm:w-54 lg:w-56 xl:w-62 2xl:w-66"
            />
          </div>
          <FeaturesList features={aiFraudSolutions.slice(2, 6)} grid3 center />
        ...
        <PageLayout className="text-center py-10 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            ...
            <div className="space-y-4 text-start">
              <TypographyMuted>
                U Tech’s team of highly experienced software developers has the
                required skills and resources to develop best-in-class fraud
                prevention software for desktop, web, and mobile devices,
                featuring key fraud prevention components including:
              </TypographyMuted>
          ...
          <FeaturesList features={internalFraudSolutions} grid3 center />
      ...
      <section className="bg-primary py-8 text-center">
        <PageLayout className="space-y-4 text-white">
          <TypographyH3>
            U Tech ADDRESSES & PRIORITIZES DATA SECURITY COMPLIANCE REQUIRED BY
            AN INCREASING NUMBER OF LAWS, STANDARDS, & REGULATIONS.
          </TypographyH3>
          <TypographyMuted>
            U Tech ensures that your custom fraud prevention solution is within
            full compliance of federal payment data security regulations,
            including PCI-DSS, HIPAA, GDPR, FISMA, FFIEC, CMMC,
            ISO-27001/ISO-27002, NERC, GLBA, NIST 800-171, NIST 800-53, SSAE 18,
            and all other federal and/or state-mandated consumer & payment data
      ...
      <PageLayout className="py-12 text-center space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          <img
            ...
            alt="Migration Planning Dashboard"
            className="mx-auto w-66 sm:w-76 md:w-120"
          />
          <FeaturesList features={fraudSolutions2} iconAlign="horizontal" />
        </div>
      </PageLayout>
      ...
      <PageLayout className="py-16 space-y-8 text-center">
        ...
        />
        <div className="flex justify-between gap-8 md:flex-row flex-col md:items-center">
      ...
      <PageLayout className="space-y-10 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          <img
            ...
            alt="Migration Planning Dashboard"
            className="mx-auto w-82 sm:w-110 md:w-120"
          />
          <FeaturesList features={fraudIntegrationSolutions} center grid />
        </div>
      ...
      <div className="py-16">
        <FaqSection
          faqs={fraudDetectionFAQ}
          title="Fraud Detection Software: FAQ's"
        />
      </div>
