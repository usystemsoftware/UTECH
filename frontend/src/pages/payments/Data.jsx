export const PymentSoftwareLeftFeatures = [
  {
    label: "ACH & Check 21",
    icon: "FileText", // Document or text-based file icon
  },
  {
    label: "Billing",
    icon: "Send", // Send/paper plane icon (symbolizing invoice dispatch)
  },
  {
    label: "Clover",
    icon: "ListChecks", // Feature checklist or POS options
  },
  {
    label: "EMV",
    icon: "CreditCard", // Credit card chip icon (EMV-related)
  },
  {
    label: "Equinox",
    icon: "Cpu", // Device or hardware/POS terminal icon
  },
  {
    label: "Fiserv",
    icon: "Database", // Database/server icon (financial backend)
  },
  {
    label: "Fraud Protection & Detection",
    icon: "ShieldCheck", // Security shield icon (fraud protection)
  },
  {
    label: "Lngenico",
    icon: "MonitorSmartphone", // POS device (monitor + mobile) icon
  },
];
export const PymentSoftwareRightFeatures = [
  {
    label: "Cryptocurrency",
    icon: "Coins", // Cryptocurrency/coins icon
  },
  {
    label: "Mobile Payments",
    icon: "Smartphone", // Mobile/phone payment icon
  },
  {
    label: "Online Payments",
    icon: "Globe", // Internet/online global icon
  },
  {
    label: "Payment Gateways & Processors",
    icon: "Repeat", // Workflow/integration icon
  },
  {
    label: "Terminal POS",
    icon: "Touchpad", // POS terminal icon
  },
  {
    label: "Verifone",
    icon: "Server", // POS hardware/server device icon
  },
  {
    label: "E Wallet",
    icon: "Wallet", // Digital wallet icon
  },
  {
    label: "PAX",
    icon: "TabletSmartphone", // POS terminal/mobile device icon
  },
];
...
export const Pymentlogs = [
  {
    logos: ["paypal", "stripe", "fiserv", "amazon", "elavon", "authorize"], // actual logo file names
  },
];
...
export const gamingPayment = [
  ...
  {
    icon: "BarChart3",
    title: "Enhanced Customer Payment",
    description:
  ...
  {
    icon: "SatelliteDish",
    title: "Cognitive Payment Systems",
    description:
...
export const PaymentTransformationFeatures = [
  {
    ...
    description:
      "We implement embedded legal document management software , enabling users to store, locate, and manage all matter-related work documents in a centralized document database..",
  },
  {
    icon: "Smartphone",
    title: "Court Case Management",
    description:
      "We develop court case management software into existing systems to update schedules daily so that legal professionals never forget a court date..",
  },
  {
    icon: "FileBarChart",
    title: "Law Firm Account Management",
    description:
      "We integrate law firm account management software with management systems to provide full visibility and control over expenses and account information.",
  },
  {
    icon: "FileBarChart",
...
export const Pymentlogsonline = [
  {
    logos: ["skrill", "stripe", "wepay", "adyen", "venmo", "neteller"], // actual logo file names
  },
];

export const PaymentTransformationsolution = [
    {
        icon: "Smartphone",
        title: "Point of Sale Programming",
        description:
