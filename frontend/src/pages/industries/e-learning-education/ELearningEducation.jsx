    ...
    return (
        <>
            ...
            <section className="bg-secondary py-16">
                <PageLayout className="space-y-16 text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                        <FeaturesList features={aiPoweredELearningSolutions.slice(0, 2)} fadeUp={fadeUp} />
                        <FeaturesList features={aiPoweredELearningSolutions.slice(2, 4)} fadeUp={fadeUp} />
                        <FeaturesList features={aiPoweredELearningSolutions.slice(4, 6)} fadeUp={fadeUp} />
                    </div>
                    <FadeInWhenVisible>
            ...
            <PageLayout className="py-16 space-y-10 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                    <div className="text-start">
                        ...
                        <FeaturesList fadeUp={fadeUp} features={elearningFeatures.slice(0, 2)} />
                    </div>
                    <FadeInWhenVisible delay={0.5} className="md:block hidden">
                        <img
                            loading="lazy"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                    ...
                    <FeaturesList fadeUp={fadeUp} features={elearningFeatures.slice(2, 4)} />
                </div>
                ...
                <PageLayout className='space-y-8 text-center'>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <FeaturesList fadeUp={fadeUp} features={sisSolutions.slice(0, 2)} />
                            <FeaturesList fadeUp={fadeUp} features={sisSolutions.slice(2, 4)} />
                        </div>
            ...
            <PageLayout className='space-y-8 py-10 text-center'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                    ...
                    <div className="text-start">
                        ...
                        <TypographyMuted className="mb-8">
                            U Tech delivers highly advanced and sophisticated WBT systems for academic institutions, enterprise-level corporations, and small-to-midsize businesses to conveniently, cost-effectively, and flexibly train employees.
                        </TypographyMuted>
                        <FeaturesList fadeUp={fadeUp} features={trainingSolutionsFeatures} />
                    </div>
                </div>
            </PageLayout>
            ...
            <section className="bg-secondary py-8">
                <PageLayout className='space-y-8 text-center'>
                    <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <FeaturesList fadeUp={fadeUp} features={webBasedTrainingFeatures.slice(0, 2)} />
                            <FeaturesList fadeUp={fadeUp} features={webBasedTrainingFeatures.slice(2, 4)} />
                        </div>
            ...
            <PageLayout className='text-center py-8 space-y-8'>
                ...
                />
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                    <FeaturesList features={elearningSupportServices.slice(0, 3)} fadeUp={fadeUp} />
                    <FeaturesList features={elearningSupportServices.slice(3, 6)} fadeUp={fadeUp} />
                </div>
                <FadeInWhenVisible>
                    <Button variant='hover'>
