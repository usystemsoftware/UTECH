    ...
    return (
        <>
            ...
            <PageLayout className='space-y-8 py-12 text-center'>
                ...
                <div className="flex flex-col md:flex-row justify-baseline gap-8 md:gap-26">
                    {/* Left Features List */}
                    <FeaturesList features={hospitalSystemFeatures.slice(0, 2)} fadeUp={fadeUp} />
                    ...
                    {/* Right Features List */}
                    <FeaturesList features={hospitalSystemFeatures.slice(2, 4)} fadeUp={fadeUp} />
                </div>
                <FadeInWhenVisible>
                    <Button variant="hover">
            ...
            <PageLayout className="py-16 space-y-10 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <FeaturesList fadeUp={fadeUp} features={hl7IntegrationFeatures.slice(0, 2)} />
                        <FeaturesList fadeUp={fadeUp} features={hl7IntegrationFeatures.slice(2, 4)} />
                    </div>
                </div>
                <FadeInWhenVisible>
                    <Button variant='hover'>
                        GET HL7 INTERGRATION
                    </Button>
                </FadeInWhenVisible>
            </PageLayout>
            ...
            <section className="bg-secondary py-16">
                <PageLayout className="space-y-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                        <FeaturesList features={healthcareSupportServices.slice(0, 2)} fadeUp={fadeUp} />
                        <FeaturesList features={healthcareSupportServices.slice(2, 4)} fadeUp={fadeUp} />
                        <FeaturesList features={healthcareSupportServices.slice(4, 6)} fadeUp={fadeUp} />
                    </div>
                </PageLayout>
            </section>
            ...
            <section className="bg-secondary py-12">
                <PageLayout className='space-y-10 text-center'>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <FeaturesList features={assistiveTechnologyFeatures} fadeUp={fadeUp} />
                    </div>
                    <FadeInWhenVisible>
                        <Button variant='hover'>
            ...
            <PageLayout className='space-y-8 py-12 text-center'>
                ...
                <div className="flex flex-col md:flex-row justify-baseline gap-8 md:gap-26">
                    {/* Left Features List */}
                    <FeaturesList features={veterinarySoftwareFeatures.slice(0, 2)} fadeUp={fadeUp} />
                    ...
                    {/* Right Features List */}
                    <FeaturesList features={veterinarySoftwareFeatures.slice(2, 4)} fadeUp={fadeUp} />
                </div>
                <FadeInWhenVisible>
                    <Button variant="hover">
