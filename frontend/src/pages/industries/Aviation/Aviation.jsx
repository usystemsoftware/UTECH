            ...
            <section className="bg-secondary py-12">
                <PageLayout className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <FeaturesList features={airlineAIandAutomationServices.slice(0, 3)} fadeUp={fadeUp} />
                        <FadeInWhenVisible>
                            <img
                        ...
                        <FeaturesList features={airlineAIandAutomationServices.slice(3, 6)} fadeUp={fadeUp} />
                    </div>
            ...
            <PageLayout className="py-16 space-y-10 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <FeaturesList fadeUp={fadeUp} features={airlineOperationsServices.slice(0, 2)} />
                        <FeaturesList fadeUp={fadeUp} features={airlineOperationsServices.slice(2, 4)} />
                    </div>
                ...
                <FadeInWhenVisible>
                    <Button variant='hover'>
                        GET FLIGHT OPS SOFTWARE DEVELOPES
                    </Button>
                </FadeInWhenVisible>
            </PageLayout>
            ...
            <section className="py-16 bg-secondary">
                <PageLayout className="space-y-10 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <FeaturesList fadeUp={fadeUp} features={airlineReservationSolutions.slice(0, 2)} />
                                <FeaturesList fadeUp={fadeUp} features={airlineReservationSolutions.slice(2, 4)} />
                            </div>
                            <TypographyMuted>
                                Integrate with leading GDSs and airline reservation system providers, such as Sabre, Galileo, Amadeus, and FlightsLogic, to create a unified platform for airline operators.
                            </TypographyMuted>
                    ...
                    <FadeInWhenVisible>
                        <Button variant='hover'>
                            GET AIRLINE SOFTWARE DEVELOPES
                        </Button>
                    </FadeInWhenVisible>
                </PageLayout>
            </section>

            <PageLayout className="my-16 py-16 grid grid-cols-1 md:grid-cols-2 space-y-10 bg-cyan-50">
                <div className="space-y-8">
                    <TypographyH5>
                        U Tech ENSURES COMPLIANCE WITH AVIATION INDUSTRY REGULATORY STANDARDS
                    </TypographyH5>
                    <TypographyMuted>
            ...
            <section className="bg-secondary py-12">
                <PageLayout className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-12">
                        <FeaturesList features={aviationMroSolutions.slice(0, 2)} fadeUp={fadeUp} />
                        <FadeInWhenVisible>
                            <img
                        ...
                        <FeaturesList features={aviationMroSolutions.slice(2, 4)} fadeUp={fadeUp} />
                    </div>
                </PageLayout>
            </section>
            ...
            <PageLayout className='py-12 space-y-12 text-center'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="grid gap-4">
                        ...
                        <TypographyMuted>
                            Leverage ArcGIS by ESRI, along with other leading drone software solutions like FlytBase, DroneDeploy, and Pix4DMapper to transform drone image capture.
                        </TypographyMuted>
