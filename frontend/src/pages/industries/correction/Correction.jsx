        ...
        <>
            ...
            <PageLayout className="py-16 space-y-10 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                    ...
                    <div className="text-start">
                        ...
                        <FeaturesList fadeUp={fadeUp} features={facilityOperationsSolutions} />
                    </div>
            ...
            <section className="bg-secondary pt-10 space-y-6">
                <PageLayout >
                    <div className="grid grid-cols-1 sm:grid-cols-2">
                        <FeaturesList fadeUp={fadeUp} features={correctionalAdminSolutions.slice(0, 2)} />
                        <FeaturesList fadeUp={fadeUp} features={correctionalAdminSolutions.slice(2, 4)} />
                    </div>
                </PageLayout>
            ...
            <PageLayout className='py-16 space-y-8 text-center'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <FeaturesList fadeUp={fadeUp} features={inmateServicesSolutions.slice(0, 2)} />
                        <FeaturesList fadeUp={fadeUp} features={inmateServicesSolutions.slice(2, 4)} />
                    </div>
                </div>
                <FadeInWhenVisible>
                    <Button variant="hover">
            ...
            <section className="bg-secondary py-16">
                <PageLayout className="space-y-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <FeaturesList fadeUp={fadeUp} features={aiDrivenCorrectionalSolutions.slice(0, 2)} />
                        <FeaturesList fadeUp={fadeUp} features={aiDrivenCorrectionalSolutions.slice(2, 4)} />
                    </div>
                </PageLayout>
            </section>
            ...
            <PageLayout className='py-16 space-y-8 text-center'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <FeaturesList fadeUp={fadeUp} features={inmateHealthcareSolutions.slice(0, 2)} />
                        <FeaturesList fadeUp={fadeUp} features={inmateHealthcareSolutions.slice(2, 4)} />
                    </div>
                    <FadeInWhenVisible delay={0.5}>
                        <img
                            loading="lazy"
            ...
            <section className="py-12 bg-secondary">
                <PageLayout className='space-y-8 text-center'>
                    ...
                    <div className="flex flex-col md:flex-row justify-baseline gap-8 md:gap-26">
                        {/* Left Features List */}
                        <FeaturesList features={inmateManagementSolutions.slice(0, 2)} fadeUp={fadeUp} />
                        ...
                        {/* Right Features List */}
                        <FeaturesList features={inmateManagementSolutions.slice(2, 4)} fadeUp={fadeUp} />
                    </div>
                    <FadeInWhenVisible>
                        <Button variant="hover">
            ...
            <PageLayout className='py-8 space-y-8 text-center'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <FeaturesList fadeUp={fadeUp} features={jailSecuritySolutions.slice(0, 2)} />
                        <FeaturesList fadeUp={fadeUp} features={jailSecuritySolutions.slice(2, 4)} />
                    </div>
                    <FadeInWhenVisible delay={0.5}>
                        <img
                            loading="lazy"
            ...
            <section className="py-12 bg-secondary">
                <PageLayout className='py-8 space-y-8 text-center'>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <FeaturesList fadeUp={fadeUp} features={inmateReleaseSolutions.slice(0, 2)} />
                            <FeaturesList fadeUp={fadeUp} features={inmateReleaseSolutions.slice(2, 4)} />
                        </div>
                    </div>
                </PageLayout>
            </section>
            ...
            <PageLayout className="py-16 space-y-10 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                    ...
                    <div className="text-start">
                        ...
                        <FeaturesList fadeUp={fadeUp} features={correctionalHrSecuritySolutions} />
                    </div>
