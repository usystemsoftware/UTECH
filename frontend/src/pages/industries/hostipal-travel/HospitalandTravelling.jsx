        ...
        <>
            ...
            <PageLayout className="space-y-16 py-16 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                    <FeaturesList features={hospitalityServices.slice(0, 2)} fadeUp={fadeUp} />
                    <FeaturesList features={hospitalityServices.slice(2, 4)} fadeUp={fadeUp} />
                    <FeaturesList features={hospitalityServices.slice(4, 6)} fadeUp={fadeUp} />
                </div>
            ...
            <section className="bg-secondary py-16 text-center">
                <PageLayout className="space-y-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                        <FeaturesList features={hospitalityAdditionalServices.slice(0, 2)} fadeUp={fadeUp} />
                        <FeaturesList features={hospitalityAdditionalServices.slice(2, 4)} fadeUp={fadeUp} />
                        <FeaturesList features={hospitalityAdditionalServices.slice(4, 6)} fadeUp={fadeUp} />
                    </div>
            ...
            <PageLayout className="space-y-16 py-16 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                    <FeaturesList features={hospitalitySupportServices.slice(0, 2)} fadeUp={fadeUp} />
                    <FeaturesList features={hospitalitySupportServices.slice(2, 4)} fadeUp={fadeUp} />
                </div>
            ...
            <section className="bg-secondary py-12">
                <PageLayout className='space-y-10 text-center'>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <FeaturesList features={travelportIntegrationServices} fadeUp={fadeUp} />
                    </div>
