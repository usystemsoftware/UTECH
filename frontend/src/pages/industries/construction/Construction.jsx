    ...
    return (
        <>
            ...
            <PageLayout className="text-center py-10 space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    <FeaturesList features={constructionSolutions.slice(0, 1)} />
                    <FeaturesList features={constructionSolutions.slice(1, 2)} />
                </div>
            </PageLayout>
            ...
            <PageLayout className='py-16 space-y-10'>
                ...
                />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    <FeaturesList features={supportServices.slice(0, 2)} />
                    <FeaturesList features={supportServices.slice(2, 4)} />
                </div>
            </PageLayout>
            ...
            <section className='py-16 bg-secondary space-y-10'>
                ...
                />
                <PageLayout className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <FeaturesList fadeUp={fadeUp} features={equipmentManagementSoftware} />
                    <FadeInWhenVisible delay={0.5}>
                        <img
                            loading="lazy"
