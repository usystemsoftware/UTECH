        ...
        <>
            ...
            <section className="bg-secondary py-16">
                <PageLayout className="space-y-10 text-center">
                    ...
                    />
                    <FeaturesList
                        features={aiAgricultureSolutions}
                        center
                        grid3
                    />
            ...
            <PageLayout className="text-center py-12 space-y-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 mt-16 md:grid-cols-3 gap-4 items-center">
                    <FeaturesList
                        features={farmingSolutions.slice(0, 2)}
                        center
                    />
                    ...
                    <FeaturesList
                        features={farmingSolutions.slice(2, 4)}
                        center
                    />
                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
                        <FadeInWhenVisible>
                            <img
                                ...
                                alt="Migration Planning Dashboard"
                                className="mx-auto w-96 md:w-155"
                            />
                        </FadeInWhenVisible>
                        <FeaturesList
            ...
            {/* === FAQ SECTION === */}
            <div className="py-16">
                <FaqSection faqs={agricultureFaq} title="Agriculture Software Development: FAQ's" />
            </div>
