...
// Importing all the feature data arrays for each utility domain
import {
    aiUtilitySolutions,
        ...
        <>
            ...
            <section className="bg-secondary py-16">
                <PageLayout className="space-y-10 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <FeaturesList fadeUp={fadeUp} features={utilityManagementSolutions} />
                    </div>
                    <FadeInWhenVisible>
            ...
            <PageLayout className="space-y-16 py-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                    <FeaturesList features={aiUtilitySolutions.slice(0, 2)} fadeUp={fadeUp} />
                    <FeaturesList features={aiUtilitySolutions.slice(2, 4)} fadeUp={fadeUp} />
                    <FeaturesList features={aiUtilitySolutions.slice(4, 6)} fadeUp={fadeUp} />
                </div>
            </PageLayout>
            ...
            <section className="bg-secondary py-16">
                <PageLayout className="space-y-10 text-center">
                    ...
                    />
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <FeaturesList fadeUp={fadeUp} features={electricSoftwareSolutions} />
                        <FadeInWhenVisible delay={0.5}>
                            <img
                                loading="lazy"
            ...
            <PageLayout className="space-y-10 py-8 text-center">
                ...
                <FadeInWhenVisible>
                    <Button variant='hover'>
                        GET STARTES WITH WASTE TRACKING APP
                    </Button>
                </FadeInWhenVisible>
            </PageLayout>
            ...
            <section className="bg-[#009896] py-8">
                <PageLayout className='text-center space-y-4'>
                    ...
                    <TypographyMuted className='text-white'>
                        U tech energyand utilities software expert ensure compliance withthe uniteds states environments protections energy(ERP)and resource conversion and recovery act(RCRA) laws.
                    </TypographyMuted>
                </PageLayout>
            </section>
            ...
            <PageLayout className="space-y-10 py-8 text-center">
                ...
                <FadeInWhenVisible>
                    <Button variant='hover'>
                        HIRE WIND SOFTWARTE DEVELOPERS
                    </Button>
                </FadeInWhenVisible>
            </PageLayout>
