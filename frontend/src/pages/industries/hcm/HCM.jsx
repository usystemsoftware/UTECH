        ...
        <>
            ...
            <PageLayout className='py-12 space-y-12 text-center'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="grid gap-4">
                        ...
                        <TypographyMuted>
                            We integrate with leading Human Capital Management (HCM) software solutions, including ADP Workforce Now, SAP SuccessFactors, Oracle HCM Cloud, UKG, and Workday Partner.
                        </TypographyMuted>
            ...
            <PageLayout className="py-16 space-y-10 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                    ...
                    {/* Features List */}
                    <FeaturesList fadeUp={fadeUp} features={backgroundScreeningSolutions} />
                </div>

                {/* CTA Button */}
                <FadeInWhenVisible>
                    <Button variant="hover">
                        GET BACKGROUND SCREENING SOLUTIONS
                    </Button>
                </FadeInWhenVisible>
            </PageLayout>
        </>
