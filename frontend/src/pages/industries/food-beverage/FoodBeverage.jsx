    ...
    <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:items-center gap-4">
            ...
            <div className="text-start space-y-4">
              ...
              <TypographyMuted>
                ...
                through advanced automation, real-time integrations, full
                visibility & control, and comprehensive insights to increase
                legal productivity.
              </TypographyMuted>
              <FeaturesList
      ...
      <section className="bg-secondary">
        <PageLayout className="space-y-8 py-12 text-center">
          <Headline
            ...
            description="Utilize trigger-based automation to monitor moisture, acidity, and temperatures, ensuring quality control throughout the food manufacturing, processing, and storing process."
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 md:items-center gap-4">
            <FadeInWhenVisible>
              <img
      ...
      <PageLayout className="space-y-8 py-12 text-center">
        <Headline
          ...
          description="Custom food distribution software streamlines inventory management, enables quick & easy order generation, and significantly improves customer communications."
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 md:items-center gap-4">
          <div className="text-start space-y-4">
      ...
      <section className="bg-secondary">
        <PageLayout className="space-y-8 py-12 text-center">
          <Headline
            ...
            description="Custom food & beverage inventory management solutions offer detailed SKU information for lot tracking, inventory & shipment visibility, seamless EDI connectivity, and more."
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 md:items-center gap-4">
            <FadeInWhenVisible>
              <img
      ...
      <PageLayout className="py-12 bg-cyan-50 my-12 flex flex-col sm:flex-row justify-between items-center md:space-x-8">
        <div className="flex-1 space-y-4">
          ...
          <TypographyMuted>
            U Technology's food and beverage software development, integration,
            and implementation experts comply with regulatory standards
            including criteria set by the U.S. Department of Agriculture (USDA),
            Food and Drug Administration (FDA) including technical
            implementations of FDA 21 CFR Part 11, the Bioterrorism Act of 2002,
            Hazard Analysis Critical Control Points (HACCP), current Good
            Manufacturing Practices (cGMP), and Food Safety and Inspection
            Service (FSIS).
          </TypographyMuted>
        </div>
        <FadeInWhenVisible>
      ...
      <PageLayout className="space-y-8 py-12 text-center">
        <Headline
          ...
          description="Food traceability software solutions empower F&B producers to track-and-trace food and beverage supply, providing farm-to-form supply chain visibility and collaboration."
        />
