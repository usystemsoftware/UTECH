...
export default function AboutPage() {
  return (
    <>
      <SeoHead
        title="U Tech | About - Insights & Updates"
      ...
      {/*  HERO SECTION */}
      <HeroSection
        backgroundImage="/banner/Image-1.jpg"
      ...
      <section className="py-16 bg-secondary">
        <PageLayout className="space-y-12">
          ...
          <div>
            ...
            <div className="mt-8 text-center max-w-3xl mx-auto">
              <p className="md:text-lg text-sm text-gray-700 dark:text-gray-200 leading-relaxed">
                ...
                and
                <span className="font-semibold text-blue-700"> excellence</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <InfoCard
              title="Mission"
              desc="To build cutting-edge digital solutions that drive growth, efficiency, and positive impact across industries."
              icon="Goal"
            />
            <InfoCard
              title="Vision"
              desc="To become a global leader in technology innovation, empowering enterprises with sustainable and future-ready solutions."
              icon="Earth"
            />
          </div>
      ...
      <PageLayout className="py-16 space-y-10">
        <Headline
          ...
          description="We meet global standards to ensure security and trust."
        />
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <section className="bg-secondary py-16">
        <PageLayout className="space-y-10 text-center">
          <Headline
            ...
            description="Expertise across multiple sectors to deliver industry-focused solutions."
          />
          ...
          <Link
            ...
            className="rounded-full border-2 hover:text-white py-2 px-6 border-orange-400 hover:bg-orange-500"
          >
            See More.....
          </Link>
        </PageLayout>
      ...
      <section className="bg-seconday py-16">
        <PageLayout className="space-y-10">
          <Headline
            ...
            description="Proud moments that reflect our dedication to excellence."
          />
      ...
      <PageLayout className="py-12 space-y-10">
        <Headline
          ...
          description="Delivering measurable success across the globe."
        />
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 text-center">
          {companyStats.map((s) => (
            <div
              key={s.label}
              className="p-6 bg-card shadow-md border border-gray-100 rounded-lg"
            >
          ...
          <CardContent className="grid gap-8 p-10 sm:grid-cols-[1fr_auto] sm:items-center">
            <div>
              ...
              <TypographyMuted className="mt-3 leading-relaxed">
                Let’s scope it together and get your first release out in
                weeks—not months.
              </TypographyMuted>
            </div>
            <ContactUsButton
              variant="hover"
              className="border-2 uppercase hover:bg-orange-500 border-orange-500 rounded-full"
            >
    ...
    <Card className="hover:shadow-2xl text-start cursor-pointer transition-shadow duration-300 border-t-4 border-primary p-6">
      ...
      <CardContent className="grid gap-4 pt-0">
        {points.map((p) => (
          <div
            key={p}
            className="flex items-start gap-3 text-base dark:text-gray-300 text-gray-700"
          >
