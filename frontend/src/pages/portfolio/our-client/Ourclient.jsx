...
import { clients } from "./Data"; // ✅ testimonials not used, so removed
import { motion } from "framer-motion";
import img from "../../../../public/banner/Ourclient_1.jpg"
  ...
  return (
    <>
      ...
      {/* <HeroSection
        ...
        overlayOpacity={0.4}
        backgroundImage="/assets/hero/hero-default.webp" // ✅ fallback image
        backgroundSources={{
          xl: "/assets/hero/hero-4k.webp",   // ≥1600px screens
          lg: "/assets/hero/hero-1080.webp", // ≥1024px screens
          md: "/assets/hero/hero-720.webp",  // ≥768px screens
        }}
        partnerLogo="/assets/partners/sap-silver.png"
      /> */}
      <SeoHead
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-600 mb-14 max-w-2xl mx-auto">
            We are honored to work with forward-thinking enterprises and
            startups, empowering them with innovative digital solutions that
            drive growth.
          </p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
            Curious why so many businesses enjoy working with us? Here’s what
            our customers have to say in their testimonials.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 shadow-md rounded-lg p-6 text-center relative">
              <p className="text-gray-700 text-base italic mb-6">
                "We selected Chetu because of their proven track record as well
                as their impressive global software delivery model. They were
                easy to work with and delivered a quality product within the
                projected timeline and within budget."
              </p>
              <div>
            ...
            <div className="bg-gray-50 shadow-md rounded-lg p-6 text-center relative">
              <p className="text-gray-700 text-base italic mb-6">
                "The most attractive aspect of working with Chetu is the price
                and professionalism of the project team: I am provided with
                progress reports, weekly conferences, and the team very promptly
                responds to any questions or concerns I raise."
              </p>
              <div>
            ...
            <div className="bg-gray-50 shadow-md rounded-lg p-6 text-center relative">
              <p className="text-gray-700 text-base italic mb-6">
                "Chetu has provided skilled and useful programming services to
                our company with very little learning curve. The delivered code
                is clean and on-time. The daily reports and weekly team meeting
            ...
            <div className="bg-gray-50 shadow-md rounded-lg p-6 text-center relative">
              <p className="text-gray-700 text-base italic mb-6">
                "The team’s communication and professionalism stood out. They
                kept us updated with weekly progress reports and ensured timely
            ...
            <div className="bg-gray-50 shadow-md rounded-lg p-6 text-center relative">
              <p className="text-gray-700 text-base italic mb-6">
                "We were impressed with the seamless integration of their
                software into our existing system. The process was smooth and
            ...
            <div className="bg-gray-50 shadow-md rounded-lg p-6 text-center relative">
              <p className="text-gray-700 text-base italic mb-6">
                "Their technical expertise was evident from day one. The product
                they delivered has helped us scale our business operations
                significantly."
              </p>
              <div>
            ...
            <div className="bg-gray-50 shadow-md rounded-lg p-6 text-center relative">
              <p className="text-gray-700 text-base italic mb-6">
                ...
                management. Every milestone was achieved on time and within
                budget."
              </p>
              <div>
            ...
            <div className="bg-gray-50 shadow-md rounded-lg p-6 text-center relative">
              <p className="text-gray-700 text-base italic mb-6">
                "From start to finish, the experience was excellent. The team
                went above and beyond to ensure our satisfaction with the final
                product."
              </p>
              <div>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-600 mb-14 max-w-3xl mx-auto">
            ...
            business success through scalable, innovative, and reliable
            software.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-12 items-start">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-3">
                Mobile Booking Engine Application
              </p>
              <a href="#" className="text-teal-500 font-medium hover:underline">
                READ CASE STUDY &gt;&gt;
              </a>
