...
// import { IconRenderer } from "@/custom/IconRenderer"; // ✅ using IconRenderer for Lucide icons
...
//           <p className="text-gray-500 mt-4 text-sm leading-relaxed max-w-xl mx-auto">
...
//               <a href="mailto:cansultent@usystem.solutions" className="underline">
//                 cansultent@usystem.solutions
//               </a>
//             </div>
//             <div className="flex items-center">
//               <IconRenderer name="Phone" size={18} className="mr-2" />
//               <a href="tel:+6589520271" className="underline">
//                 +65 89520271
//               </a>
//             </div>
//           </div>
...
//           {/* Social Icons using IconRenderer */}
...
//                   name={platform}
//                   size={24}
//                   className="text-blue-600 hover:text-cyan-500 transition cursor-pointer"
//                 />
//               )
//             )}
//           </div>
