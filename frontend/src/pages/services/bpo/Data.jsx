...
export const servicesData = [
    ...
    {
        icon: "Calculator", // finance/accounting
        title: "Accounting",
        description:
    ...
    {
        icon: "TrendingUp", // sales enablement
...
export const industriesData = [
    ...
    {
        icon: "UtensilsCrossed", // Food & Beverage
        title: "Food & Beverage",
        description:
...
export const facilityFeatures = [
    {
        icon: "Building2", // Lucide icon for facilities
    ...
    {
        icon: "ShieldCheck", // Security & authentication
