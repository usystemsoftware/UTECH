...
export const dataProcessingSolutions = [
    {
        ...
        icon: "ListChecks", // Represents mapping and schema alignment
    },
    {
        ...
        icon: "Repeat", // Represents transformation/format change
    },
    {
        title: "Data Loading",
        description:
        ...
        icon: "UploadCloud", // Represents cloud-based data loading
    },
    {
        ...
        icon: "LifeBuoy", // Represents support and maintenance
    },
];
...
export const dataGovernanceAndSecuritySolutions = [
    {
        ...
        icon: "Brush", // Represents cleaning or refining
    },
    {
        ...
        icon: "Landmark", // Represents policy, rules, and structure
    },
    {
        ...
        icon: "Shield", // Represents data protection and security
    },
    {
        ...
        icon: "BarChart4", // Represents big data and analytics
    },
];
