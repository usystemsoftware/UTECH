      ...
      <PageLayout className="space-y-8 text-center py-10">
        ...
        <div className="space-y-4 md:text-start text-center">
          ...
          <FeaturesList3
            ...
            fadeUp={fadeUp}
            image="/assets/services/introstructure-support/introstructuresupport.png"
          />
        </div>
        ...
        <div className="space-y-4 md:text-start text-center">
          ...
          <FeaturesList3
            ...
            fadeUp={fadeUp}
            image="/assets/services/introstructure-support/recovery.png"
            reverse
          />
        </div>
        ...
        <PageLayout className="py-16 space-y-10 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-4 md:gap-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <FeaturesList
                fadeUp={fadeUp}
                features={dicominfrastructure.slice(0, 2)}
              />
              <FeaturesList
                fadeUp={fadeUp}
                features={dicominfrastructure.slice(2, 4)}
              />
            </div>
