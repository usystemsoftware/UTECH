    ...
    <>
      ...
      <PageLayout className="text-center py-10 space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
          <FeaturesList features={FinopServicesformation} fadeUp={fadeUp} iconAlign="horizontal" />
      ...
      <section className="bg-secondary">
        <PageLayout className="text-center py-10 space-y-10">
          ...
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-4">
            <FeaturesList features={FinopsFeaturesTool} fadeUp={fadeUp} iconAlign="horizontal" />
            <FadeInWhenVisible className="hidden sm:block">
              <img
                loading="lazy"
