...
export default function SoftwareSecurity() {
  return (
    <>
    <SeoHead
        title="U Tech | SoftwareSeurity - Insights & Updates"
        ...
        componentName="SoftwareSecurity"
      />
      <HeroSection
      ...
      <PageLayout className="space-y-10 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          <div className="space-y-3 order-2 md:order-1">
            ...
            <TypographyMuted>
              Our AI-driven solutions are designed to detect threats using
              advanced machine learning algorithms and deliver IOA/IOC and
              HIPS/HIDS capabilities to detect concealed malware.
            </TypographyMuted>
            <FeaturesList
      ...
      <section className="bg-secondary py-16 text-center">
        <PageLayout className="space-y-10">
          ...
          <FeaturesListOpposite features={cybersecurityAISolutions} />
        ...
        <PageLayout className="space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
            <div className="space-y-3">
              ...
              <TypographyMuted>
                Learn how our security and compliance monitoring provides a full
                360-degree view of IT risk management and incident response
                tactics to eliminate cyber threats.
              </TypographyMuted>
              <FeaturesList
            ...
            <img
              ...
              alt="Migration Planning Dashboard"
              className="mx-auto w-40 sm:w-52 xl:w-56 2xl:w-60"
            />
          </div>
        </PageLayout>
      </section>
      ...
      <section className="bg-secondary py-16">
        <PageLayout className="space-y-10">
          ...
          <FeaturesListOpposite features={cybersecurityComplianceServices} />
        </PageLayout>
      </section>
      ...
      <PageLayout className="py-16 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
          <img
            ...
            alt="Migration Planning Dashboard"
            className="mx-auto w-86 sm:w-110 md:w-135 xl:w-145"
          />
          <FeaturesList features={cybersecurityPartners} center grid />
        </div>
      </PageLayout>
