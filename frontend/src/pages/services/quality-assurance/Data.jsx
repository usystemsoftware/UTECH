...
export const qualityPlatforms = [
  ...
  },
  {
    ...
    title: "Software QA Manual Testing",
    description:
  ...
  },
  {
    ...
    title: "Software QA Usability Testing",
    description:
...
export const CustomQuality = [
  {
    ...
    iconType: "Processor Icon", // or "Hardware / Technology"
  },
  {
  ...
  },
  {
    ...
    iconType: "Automation / Bot Icon",
  },
];
export const supportServices = [
  {
    icon: "/assets/industries/energy-utilities/icons/5.svg",
    title: "QA Performance Testing Solutions",
    description:
  ...
  },
  {
    ...
    title: "QA Penetration Testing Solutions",
    description:
  ...
  },
  {
    ...
    title: "QA Localization Testing Solutions",
    description:
  ...
  },
  {
    ...
    title: "QA Regression Testing Solutions",
    description:
  ...
  },
  {
    ...
    title: "QA Security Testing Solutions",
    description:
  ...
  },
  {
    ...
    title: "QA Compatibility Testing Solutions",
    description:
...
export const QualityAssur = [
  {
    title: "QA Testing Software",
    description: (
      <>
        We customize and integrate industry-leading QA testing tools, such as
        MasterControl, TestComplete, Testsigma, and Telerik, to effectively test
        your web, mobile, and desktop applications.
      </>
    ),
    logos: ["software"],
  },
  {
    ...
    description: (
      <>
        We integrate third-party functional testing software APIs, such as
        Digivante, Selenium, Cucumber, and Test IO, to ensure that your web
        apps, mobile apps, and websites are fully functioning.
      </>
    ),
    logos: ["tools"],
  },
  {
    ...
    description: (
      <>
        We integrate leading API testing tools for APIs, including Postman,
        Apiary, Katalon Studio, and SoapUI, with custom features and
        modifications to support your systems and testing requirements.
      </>
    ),
    logos: ["testing"],
  },
  {
    title: "Cross-Browser Testing Tools",
    description: (
      <>
        We customize and integrate the best cross-browser testing tools on the
        market, such as LambdaTest, TestingBot, Ghostlab, and Browsershots, to
        test your applications and ensure successful results.
      </>
    ),
    logos: ["browser"],
  },
