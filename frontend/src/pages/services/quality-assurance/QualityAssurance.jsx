      ...
      <PageLayout className="py-16">
        ...
        <FadeInWhenVisible>
          <Headline
            ...
            description="Chetu brings together the most reliable expertise, processes, technologies, and QA testing specialists to deliver high value-added and agile-aligned QA & software testing solutions that you can trust."
          />
        </FadeInWhenVisible>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 space-y-12 items-center">
          ...
          <FadeInWhenVisible>
            <img
              ...
              width={820}
              height={240} // or any estimated height you want
            />
          </FadeInWhenVisible>
        </div>
      </PageLayout>
