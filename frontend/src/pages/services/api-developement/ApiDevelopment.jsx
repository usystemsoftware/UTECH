                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-left mt-16">
                    {apiFunctionality.map((feature, index) => (
                        <div key={index}>
                            ...
                            <div key={index} className="flex items-center sm:gap-12 gap-8 mt-8 flex-wrap">
                                {
                                    feature.logos.map((logo, index) => (
                                        <img loading="lazy" src={`/assets/services/api-development/api-conf/${logo}.png`} className="h-8 cursor-pointer hover:scale-105" alt={feature?.title} />
                                    ))
                                }
                            </div>
                        </div>
