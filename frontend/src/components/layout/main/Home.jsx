...
export const Home = () => {
  return (
    <>
      <HeroHighlight
        containerClassName="bg-gradient-to-r from-black via-zinc-700 to-white border border-white/15 shadow-xl mt-16"
        ...
        >
          ...
          >
            ...
            <p className="mt-4 text-white text-sm sm:text-base md:text-lg max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              We build smart, scalable, and user-first solutions. Whether it's
              AI, automation, or cutting-edge web tech — we bring your vision to
              life.
            </p>
