...
export const Home = () => {
  return (
    <>
      <HeroHighlight
        containerClassName="bg-gradient-to-r from-black/70 via-black/60 to-transparent backdrop-black border border-white/20 shadow-xl mt-16"
...
//     <>
//       <HeroHighlight
//         containerClassName="bg-gradient-to-r from-black via-zinc-800 to-white border border-white/15 shadow-xl"
...
//             }}
//           >
//             <div className="mb-8 text-3xl sm:text-4xl lg:text-5xl font-extrabold flex flex-wrap justify-center lg:justify-start gap-3">
//               <motion.div
//                 initial={{ x: -60, scale: 0.3 }}
//                 animate={{ x: 0, scale: 1 }}
//                 transition={{ type: "spring", stiffness: 120, damping: 30 }}
//                 className="text-white w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-gradient-to-tr from-purple-600 via-pink-500 to-yellow-500 flex items-center justify-center rounded-full shadow-xl"
//               >
//                 U
//               </motion.div>
//               <span className="text-transparent bg-gradient-to-r from-yellow-500 via-pink-500 to-purple-600 bg-clip-text">
//                 Technology
//               </span>
//             </div>
