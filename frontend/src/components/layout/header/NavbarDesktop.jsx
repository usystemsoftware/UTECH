...
const IconRenderer = ({ name }) => {
    ...
    return LucideIcon ? <LucideIcon className="w-4 h-4 hover:text-primary" /> : null;
};
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-6 flex justify-between items-center h-20">
                {/* Logo */}
                <Link to="/">
                    <img src="/logo.png" alt="Logo" className="h-12 w-42" />
                </Link>
                {/* Navigation */}
                            ...
                            <div className="flex flex-wrap justify-evenly sm:max-w-7xl mx-auto px-8 py-8 gap-6">
                                ...
                                {Navlinks[hoveredIndex].groups?.map((group, gIdx) => (
                                    <motion.div
                                        ...
                                        className="w-60"
                                    >
                                        <TypographyH5 className={`${group.group === "" ? "mb-10" : "mb-4"}`}>
                                            {group.group}
                                        </TypographyH5>
