                            ...
                            <div className="w-full h-full flex flex-col justify-center bg-gradient-to-br from-white via-amber-50 to-rose-50 shadow-2xl rounded-3xl border border-amber-100 overflow-hidden px-6 py-8 md:px-12 md:py-16">
                              ...
                              <div className="flex items-center gap-3 sm:gap-4 mb-4">
                                <div className="w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full bg-amber-100 border border-amber-200 shadow-sm">
                                  <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 sm:w-8 sm:h-8 text-amber-600" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs sm:text-sm text-gray-500">You are cordially invited</p>
                                </div>
                              </div>
                              ...
                              <div className="mt-4 text-gray-700 space-y-3 text-sm sm:text-base">
                                ...
                                <p className="hidden lg:block text-lg">
                                  With the blessings of <span className="font-semibold text-amber-700">Lord Ganesha</span>, we warmly invite you to celebrate Ganesh Chaturthi along with the inauguration of our new website. Join us for devotion, festivities, and <span className="font-semibold text-amber-700">Maha Prasad</span>.
                                </p>

                                {/* Mobile: Only Essential Info */}
                                <p className="block lg:hidden text-base font-medium">
                                  Join us for Ganesh Chaturthi & Website Launch with Maha Prasad.
                                </p>
                                ...
                                <div className="hidden lg:flex flex-col sm:flex-row sm:items-center sm:gap-12 gap-4 mt-4">
                                  <div className="bg-white rounded-xl shadow-md p-4 border border-amber-100 hover:scale-105 transition-transform w-full sm:w-auto">
                                    ...
                                    <p className="font-semibold text-gray-800 mt-1">Community Hall</p>
                                    <p className="text-sm text-gray-600">Main Street, Your City</p>
                                  </div>
                                  <div className="bg-white rounded-xl shadow-md p-4 border border-amber-100 hover:scale-105 transition-transform w-full sm:w-auto">
                                    <p className="text-xs text-gray-500 uppercase tracking-wide">🎉 Event</p>
                                    <p className="font-semibold text-gray-800 mt-1">Website Launch & Maha Prasad</p>
                                    <p className="text-sm text-gray-600">Special offerings and blessings</p>
                                  </div>
                                </div>

                                {/* Hosted By */}
                                <p className="mt-4 text-sm sm:text-base text-gray-600">
                                  Hosted by: <span className="font-semibold text-rose-700">U Technology</span>
                                </p>
                              </div>
                            </div>
                          </div>
