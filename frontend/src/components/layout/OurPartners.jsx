            ...
            <PageLayout>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center z-10 relative">
                    ...
                    <div className="md:col-span-5 space-y-6">
                        ...
                        <TypographyMuted>
                            We are your partners in innovation, delivering cutting-edge solutions for top companies across the globe.
                        </TypographyMuted>
                        <Button variant="link" className="text-orange-500 text-md px-0 font-semibold">
                            Explore Partner Ecosystem →
                        </Button>
                    </div>

                    {/* Desktop Logo Grid with Framer Motion */}
                    <div className="hidden sm:grid md:col-span-7 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
