            ...
            <PageLayout className="space-y-12 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {testimonials.map((t, i) => (
                        ...
                        >
                            <span className="absolute top-4 left-4 text-5xl text-primary font-serif">“</span>

                            <TypographyMuted className="relative z-10">{t.text}</TypographyMuted>

                            <span className="absolute bottom-4 right-4 text-5xl text-primary font-serif">”</span>
